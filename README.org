...
- A main-kafka [[examples/single-kafka/main-kafka-namespace.yml][namespace]] for running the main kafka instance
- A strimzi kafka [[examples/single-kafka/main-kafka.yml][resource]] for running Kafka
- A strimzi topic [[examples/single-kafka/topic.yml][resource]] for creating a test topic
- A test [[examples/single-kafka/test-producer.yml][producer]] that uses the main-kafka Kafka instance
- A test [[examples/single-kafka/test-consumer.yml][consumer]] that uses the main-kafka Kafka instance
